...
from SynthesEyes_dataset import GazeOnlyDataset
...
def create_loader(images_path, pickles_path, 
    ...
    train_data = GazeOnlyDataset(train_images_path, train_pickles_path, transform=albumentation_transform)
    test_data = GazeOnlyDataset(test_images_path, test_pickles_path, transform=None)
